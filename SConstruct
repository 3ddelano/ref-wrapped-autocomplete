...
opts.Add(PathVariable('target_path',
         'The path where the lib is installed.', 'project/bin/'))  # Keep the library in the root of the project as a godot bug workaround
opts.Add(PathVariable('target_name', 'The library name.',
         'libcustom-class', PathVariable.PathAccept))
